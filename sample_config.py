...
class Config(object):
    ...
    GOD_STRING = os.environ.get("GOD_STRING", None)
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Godfatherakkii/Godfather-addons"
    )
